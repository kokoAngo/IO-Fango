...
/// @title TestToken — minimal ERC-20 with public mint, for local escrow tests.
/// @dev NOT for production. The real chain supplies its own ERC-20; only its
///      address goes in FANGO_CHAIN_TOKEN_ADDR.
contract TestToken {
    string public name = "FangoTestToken";
